...
class MyWidget(QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        self.action_5.triggered.connect(self.km)
        self.action_6.triggered.connect(self.kl)
        self.action_7.triggered.connect(self.ks)
        self.action_8.triggered.connect(self.kv)
        self.action_9.triggered.connect(self.kt)
        self.action_10.triggered.connect(self.kv2) #os.system
    def s2(self):
        open('sistem.txt', 'w').write(str(2))
    def s8(self):
        open('sistem.txt', 'w').write(str(8))
    def s10(self):
        open('sistem.txt', 'w').write(str(10))
    def s16(self):
        open('sistem.txt', 'w').write(str(16))
    def s2(self):
        pass
    def s2(self):
        pass
    ...
    def rez(self):
        ...
        try:
            ...
            r = str(eval(prim))
            '''if sistem != 10:
                r = str(SOCC(10, sistem, r))''' #не работает
